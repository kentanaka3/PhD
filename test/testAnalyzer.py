...
class TestPickParser(unittest.TestCase):
  @unittest.mock.patch("sys.argv",
                       ["Analyzer.py", "-D", "230601", "230604", "-v", "-d",
                        str(TEST_PATH), "--file", str(FILENAME)])
  def test_parse_pick(self):
    ...
    SOURCE, DETECT = event_parser(args.file[0], args)
...
class TestEventCounter(unittest.TestCase):
  @unittest.mock.patch("sys.argv",
                       ["Analyzer.py", "-D", "230601", "230604", "-v", "-d",
                        str(TEST_PATH), "-M", PHASENET_STR, "--file",
                        str(FILENAME)])
...
class TestConfMtx(unittest.TestCase):
  ...
  def test_perfect(self):
    ...
    EXPECTED = set()
    EXPECTED.add(((ID, None), (str(UTCDateTime(2023, 6, 1, 0, 1, 2, 3)),
                               str(UTCDateTime(2023, 6, 1, 0, 1, 2, 3))),
                  (3, 0.43185002), PWAVE, NETWORK, STATION))
    EXPECTED.add(((ID, None), (str(UTCDateTime(2023, 6, 1, 0, 4, 5, 6)),
  ...
  def test_true_pred(self):
    ...
    self.assertListEqual(EXPECTED, CFN_MTX.values.tolist())
    EXPECTED = set()
    EXPECTED.add(((ID, None), (str(UTCDateTime(2023, 6, 1, 0, 1, 2, 0)),
                               str(UTCDateTime(2023, 6, 1, 0, 1, 2, 500000))),
                  (3, 0.43185002), PWAVE, NETWORK, STATION))
    EXPECTED.add(((ID, None), (str(UTCDateTime(2023, 6, 1, 0, 1, 3, 0)),
  ...
  def test_true_pred_complex(self):
    ...
    EXPECTED.add(((ID, None), (str(UTCDateTime(2023, 6, 1, 0, 1, 2, 500000)),
