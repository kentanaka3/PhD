...
class TestPickParser(unittest.TestCase):
  ...
  def test_parse_pick(self):
    ...
    EXPECTED = [
      [2023000898, UTCDateTime(2023, 6, 1, 9, 27, 58, 710000),  0, PWAVE, None, 'CAE'],
      [2023000898, UTCDateTime(2023, 6, 1, 9, 27, 59, 360000),  2, SWAVE, None, 'CAE'],
      [2023000899, UTCDateTime(2023, 6, 1, 9, 53, 32, 530000),  2, PWAVE, None, 'CAE'],
      [2023000899, UTCDateTime(2023, 6, 1, 9, 53, 36, 360000),  3, SWAVE, None, 'CAE'],
      [2023000903, UTCDateTime(2023, 6, 1, 21, 41, 16, 740000), 0, PWAVE, None, 'CAE'],
      [2023000903, UTCDateTime(2023, 6, 1, 21, 41, 19, 90000),  0, SWAVE, None, 'CAE'],
      [2023000908, UTCDateTime(2023, 6, 3, 0, 31, 40, 50000),   2, PWAVE, None, 'BAD'],
      [2023000908, UTCDateTime(2023, 6, 3, 0, 31, 43, 560000),  1, SWAVE, None, 'BAD'],
      [2023000909, UTCDateTime(2023, 6, 3, 5, 18, 36, 10000),   2, PWAVE, None,'VARA'],
      [2023000909, UTCDateTime(2023, 6, 3, 5, 18, 39, 980000),  2, SWAVE, None,'VARA'],
      [2023000911, UTCDateTime(2023, 6, 3, 12, 33, 23, 350000), 0, PWAVE, None,'VARA'],
      [2023000911, UTCDateTime(2023, 6, 3, 12, 33, 25, 980000), 0, SWAVE, None,'VARA'],
      [2023000912, UTCDateTime(2023, 6, 3, 16, 54, 16, 760000), 2, PWAVE, None, 'BAD'],
      [2023000912, UTCDateTime(2023, 6, 3, 16, 54, 19, 950000), 2, SWAVE, None, 'BAD'],
      [2023000915, UTCDateTime(2023, 6, 4, 0, 3, 5, 450000),    0, PWAVE, None, 'BAD'],
      [2023000915, UTCDateTime(2023, 6, 4, 0, 3, 8, 340000),    2, SWAVE, None, 'BAD'],
      [2023000916, UTCDateTime(2023, 6, 4, 0, 25, 9, 150000),   3, PWAVE, None, 'TRI'],
      [2023000916, UTCDateTime(2023, 6, 4, 0, 25, 14, 520000),  3, SWAVE, None, 'TRI'],
      [2023000916, UTCDateTime(2023, 6, 4, 0, 25, 10, 760000),  1, PWAVE, None, 'BAD'],
      [2023000916, UTCDateTime(2023, 6, 4, 0, 25, 16, 420000),  2, SWAVE, None, 'BAD'],
      [2023000919, UTCDateTime(2023, 6, 4, 17, 57, 11, 390000), 3, PWAVE, None, 'CAE'],
      [2023000919, UTCDateTime(2023, 6, 4, 17, 57, 17, 250000), 2, SWAVE, None, 'CAE']
    ]
    ...
    EXPECTED = [
      ...
      [2023000909, UTCDateTime(2023, 6, 3, 5, 18, 30, 810000), 45.6645, 10.626333333333333, 10.53, 1.6, 19, 147, 4.0, 0.1, 0.3, 0.5, 'B1', None],
      [2023000911, UTCDateTime(2023, 6, 3, 12, 33, 19, 650000), 45.750166666666665, 11.105333333333334, 9.43, 1.2, 13, 127, 14.9, 0.11, 0.4, 1.0, 'B1', None],
