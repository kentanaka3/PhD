...
class TestArgparse(unittest.TestCase):
  ...
  def test_default(self):
    ...
    self.assertEqual(args.groups, [DATE_STR, NETWORK_STR, STATION_STR])
  ...
  @unittest.mock.patch("sys.argv", ["picker.py", "-G", DATE_STR])
  def test_group_args(self):
    args = ini.parse_arguments()
    self.assertEqual(args.groups, [DATE_STR])

  @unittest.mock.patch("sys.argv",
                       ["picker.py", "-G", DATE_STR, NETWORK_STR])
  def test_groups_args(self):
    args = ini.parse_arguments()
    self.assertEqual(args.groups, [DATE_STR, NETWORK_STR])
