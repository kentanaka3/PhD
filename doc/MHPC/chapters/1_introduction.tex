...
\begin{itemize}
  \item \textbf{Body waves} are seismic waves that travel through the Earth's
    ...
    \begin{itemize}
      \item \textbf{P waves} (Primary or Compressional waves): These are the
        fastest seismic waves and the first to be recorded by seismometers.
        They propagate through solids, liquids, and gases by compressing and
        expanding the medium in the direction of propagation
        (longitudinal motion).
      \item \textbf{S waves} (Secondary or Shear waves): S waves are slower
        than P waves and arrive second. They propagate only through solid
        materials, moving the medium perpendicular to the direction of
        propagation (transverse motion).
    \end{itemize}
  \item \textbf{Surface waves} propagate along the Earth's surface. While
    ...
    responsible for the majority of structural damage. They include
    \textbf{Love waves} (horizontal shear) and \textbf{Rayleigh waves}
