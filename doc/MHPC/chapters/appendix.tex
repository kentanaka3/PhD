...
The following YAML configuration file defines the complete computational pipeline for automated seismic phase picking and earthquake catalog generation. This configuration instantiates all modules described in Chapter~\ref{chap:Pipeline}, including data access, phase picking, event association, hypocenter location, and magnitude estimation.
