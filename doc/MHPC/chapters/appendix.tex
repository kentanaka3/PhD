...
The following YAML configuration file defines the complete
computational pipeline for automated seismic phase picking and
earthquake catalog generation. This configuration instantiates all
modules described in Chapter~\ref{chap:Pipeline}, including data
access, phase picking, event association, hypocenter location, and
...
data:
  ...
  - /Users/admin/Desktop/OGS_Catalog/station/
  channel_priorities:
  - HH?
  - EH?
  - HN?
