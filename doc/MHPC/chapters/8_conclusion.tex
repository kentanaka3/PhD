...
\begin{itemize}
  \item \textbf{3D velocity models.} All locations in this study were computed
    with a 1D layered velocity model. Replacing the 1D model with a
    regional 3D velocity model is
  ...
  \item \textbf{Magnitude calibration.} The bimodal residual pattern observed
    below $M_L \approx 2$, with systematic underestimation of
    0.3--0.8 magnitude
  ...
  \item \textbf{Proposed-event validation.} The 810--1,304 proposed events
    ...
    represent genuine uncataloged micro-seismicity, and
