...
# Headers
MATCH_DICT = {
  PICKER_STR : [PWAVE, SWAVE, NONE_STR],
  GMMA_STR : [EVENT_STR, NONE_STR],
}
MATCH_CTGR = {
  PICKER_STR : [PHASE_STR, PROBABILITY_STR],
  GMMA_STR : [TIMESTAMP_STR, LATITUDE_STR, LONGITUDE_STR, LOCAL_DEPTH_STR,
              MAGNITUDE_STR],
}
MATCH_CNFG = {
  PICKER_STR : {
    METHOD_STR : PICKER_STR,
