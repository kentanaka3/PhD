...
This file adds GitHub Copilot-specific guidance; it may not weaken `AGENTS.md`.
...
bash .agents/skills/agent-creator/scripts/validate-agent.sh github path/to/SKILL.md
...
GitHub Copilot uses hierarchical discovery (`../AGENTS.md`, `../.github/copilot-instructions.md`,  `../.github/agents/`, `../.claude/agents/`) and on-demand skill activation under `../.agents/skills/`.
