# Gemini Intelligence project instructions

Read and follow [`AGENTS.md`](AGENTS.md) — it is the repository-wide contract.
This file adds Gemini Intelligence and Google Antigravity-specific guidance; it may not weaken `AGENTS.md`.

## Scientific project overview

The OGS project is a seismicity analysis pipeline (waveform acquisition → catalog parsing → ML phase picking → phase association → event location → clustering → visualization).
...
Antigravity uses hierarchical discovery (`AGENTS.md`, `GEMINI.md`,  `.github/agents/`, `.claude/agents/`) and on-demand skill activation under `.agents/skills/`.
...
- [`.agents/skills/latex-docxer/SKILL.md`](.agents/skills/latex-docxer/SKILL.md) — Scientific LaTeX document creation, review, and evidence-bounded builds.
...
## Scientific and cluster boundaries
